...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in LogSelectors) DeepCopyInto(out *LogSelectors) {
	{
		in := &in
		*out = make(LogSelectors, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LogSelectors.
func (in LogSelectors) DeepCopy() LogSelectors {
	if in == nil {
		return nil
	}
	out := new(LogSelectors)
	in.DeepCopyInto(out)
	return *out
}
