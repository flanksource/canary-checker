...
func (in *CanarySpec) DeepCopyInto(out *CanarySpec) {
	*out = *in
	...
	if in.GCSBucket != nil {
		...
		*out = make([]GCSBucketCheck, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *GCSBucket) DeepCopyInto(out *GCSBucket) {
	*out = *in
	in.GCSBucketCheck.DeepCopyInto(&out.GCSBucketCheck)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GCSBucketCheck) DeepCopyInto(out *GCSBucketCheck) {
	*out = *in
	out.Description = in.Description
	out.Templatable = in.Templatable
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GCSBucketCheck.
func (in *GCSBucketCheck) DeepCopy() *GCSBucketCheck {
	if in == nil {
		return nil
	}
	out := new(GCSBucketCheck)
	in.DeepCopyInto(out)
	return out
}
...
func (in *S3Bucket) DeepCopyInto(out *S3Bucket) {
	*out = *in
	in.S3BucketCheck.DeepCopyInto(&out.S3BucketCheck)
}
...
func (in *Smb) DeepCopyInto(out *Smb) {
	*out = *in
	in.SmbCheck.DeepCopyInto(&out.SmbCheck)
}
