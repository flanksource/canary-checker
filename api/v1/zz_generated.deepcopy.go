...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GitLabCheck) DeepCopyInto(out *GitLabCheck) {
	*out = *in
	in.Description.DeepCopyInto(&out.Description)
	out.Templatable = in.Templatable
	in.Password.DeepCopyInto(&out.Password)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GitLabCheck.
func (in *GitLabCheck) DeepCopy() *GitLabCheck {
	if in == nil {
		return nil
	}
	out := new(GitLabCheck)
