...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PushLocation) DeepCopyInto(out *PushLocation) {
	*out = *in
	in.Auth.DeepCopyInto(&out.Auth)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PushLocation.
func (in *PushLocation) DeepCopy() *PushLocation {
	if in == nil {
		return nil
	}
	out := new(PushLocation)
	in.DeepCopyInto(out)
	return out
}
