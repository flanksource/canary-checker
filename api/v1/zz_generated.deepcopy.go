...
func (in *AlertManagerCheck) DeepCopyInto(out *AlertManagerCheck) {
	*out = *in
	...
	in.Templatable.DeepCopyInto(&out.Templatable)
	if in.Auth != nil {
...
func (in *TestTemplate) DeepCopyInto(out *TestTemplate) {
	*out = *in
	out.Template = in.Template
	if in.TestThreshold != nil {
		in, out := &in.TestThreshold, &out.TestThreshold
		*out = new(TestThreshold)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TestThreshold) DeepCopyInto(out *TestThreshold) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TestThreshold.
func (in *TestThreshold) DeepCopy() *TestThreshold {
	if in == nil {
		return nil
	}
	out := new(TestThreshold)
