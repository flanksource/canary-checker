...
func (in *CanarySpec) DeepCopyInto(out *CanarySpec) {
	*out = *in
	...
	if in.KubernetesCreator != nil {
		in, out := &in.KubernetesCreator, &out.KubernetesCreator
		*out = make([]KubernetesCreatorCheck, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubernetesCreatorCheck) DeepCopyInto(out *KubernetesCreatorCheck) {
	*out = *in
	out.Description = in.Description
	out.Templatable = in.Templatable
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesCreatorCheck.
func (in *KubernetesCreatorCheck) DeepCopy() *KubernetesCreatorCheck {
	if in == nil {
		return nil
	}
	out := new(KubernetesCreatorCheck)
	in.DeepCopyInto(out)
	return out
}
